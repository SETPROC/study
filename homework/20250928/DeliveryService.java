...
public class DeliveryService {
	...
	public void deliveryAnalysis() {
		List<DeliveryDTO> deliveryList = dao.findAll();

		if (deliveryEmpty()) return;
		
		System.out.println("등록된 상품은 총 "+ deliveryList.size() + "입니다.");
		System.out.println("판매 시 총 "+
				String.format("%,d", deliveryList.stream().mapToInt(dto -> dto.getTotal()).sum()) + "원 입니다.");
	}
